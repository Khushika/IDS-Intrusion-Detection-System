...
train_data_path = r"C:\Users\mamid\Downloads\Train_data.csv"
test_data_path = r"C:\Users\mamid\Downloads\Test_data.csv"
...
try:
    model = load_model(r'C:\Users\mamid\Downloads\cnn_model.h5')
...
def preprocess_input(input_data):
    ...
    X = np.array(input_df).reshape(len(input_df), input_df.shape[1], 1)
    return X
